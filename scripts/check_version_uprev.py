...
version_pattern = re.compile(r"^data-version: (?P<prefix>\S+)/(?P<version>\S+)")

REFERENCE_URL = "https://raw.githubusercontent.com/HUPO-PSI/xlmod-CV/main/XLMOD.obo"
...
def get_checksum_and_version(stream):
    ...
    for line in stream:
        ...
        if data_version is None:
            ...
            if match:
                data_version = version.parse(match.groupdict()['version'])
